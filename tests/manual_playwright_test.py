    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.fill(
                ...
                "This is a test post created using Playwright automation",
            )
            page.fill(
                'textarea[name="body"]',
                "This is the body content of the test post. It was created automatically using Playwright to test the admin interface.",
            )
